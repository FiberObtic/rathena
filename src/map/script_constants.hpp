...
/// Do not modify code above this, since it will be automatically generated by the API again
	export_constant(EFST_CASH_VIP);			// TAURUS VIP Icon.
	export_constant(EFST_PREMIUMSERVICE);	// TAURUS Premium Service Icon.
	export_constant(EFST_PREMIUM_EXPBOOST);	// TAURUS Premium Service Icon.
	export_constant(EFST_PREMIUM_JEXPBOOST);	// TAURUS Premium Service Icon.
	export_constant(EFST_PREMIUM_ITEMBOOST);	// TAURUS Premium Service Icon.
	export_constant(EFST_RANKVOTE_1);
	export_constant(EFST_RANKVOTE_2);
	export_constant(EFST_RANKVOTE_3);
	export_constant(EFST_RANKVOTE_4);
	export_constant(EFST_RANKVOTE_5);
	export_constant(EFST_RANKVOTE_6);
	export_constant(EFST_RANKVOTE_7);
	export_constant(EFST_RANKVOTE_8);
	export_constant(EFST_RANKVOTE_9);
	export_constant(EFST_RANKVOTE_10);
	export_constant(EFST_RANKMVP_1);
	export_constant(EFST_RANKMVP_2);
	export_constant(EFST_RANKMVP_3);

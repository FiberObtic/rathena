			...
			<div class="ui tall stacked segments">
			  ...
			  <div class="ui segment">
				<div class="main-header">
					<span>Rank LV. (Exp) (เมื่อ Lv. 9970)</span>
					<p style="font-size:12px;font-weight: normal;">รายละเอียดกิจกรรม</p>
				</div>
				<!-- Text Event -->
				
				<p>กิจกรรม Rank LV. (Exp) (เมื่อ Lv. 99/70)</p>

<p style="text-align:center"><a href="images/event/BannerF4.jpeg"><img alt="" src="images/event/BannerF4.jpeg" /></a></p>

<p style="text-align:center">&nbsp;</p>

<p>สำหรับสมาชิกที่ Lv.99/70 แล้ว สมาชิกสามารถเก็บค่าประสบการณ์ (Exp Lv.) เพื่อนำมาแลกเปลี่ยนเป็นไอเทม Rank_Exp ได้ที่ NPC ภายในเมือง ไอเทม Rank_Exp เมื่อกดใช้จะได้รับ Exp&nbsp; (สามารถแลกเปลี่ยนได้)</p>

<p style="text-align:center"><a href="images/event/Screenshot-2023-09-17-042720.jpeg"><img alt="" src="images/event/Screenshot-2023-09-17-042720.jpeg" style="height:419px; width:586px" /></a></p>

<p style="text-align:center">&nbsp;</p>

<p>หมายเหตุ : กิจกรรม Rank LV การแลก ไอเทม&nbsp;Rank_Exp จะคิดค่าประสบการณ์ (Exp Lv.) ส่วนที่เกินมาเท่านั้น!! ไม่ส่งผลต่อตัวละครของสมาชิก</p>

...
if($objResultPay["NumQRNotPay"] > 10)  {
	...
	$strSQL = "INSERT INTO payment (user_id,confirmId,transactionId,amount,status,added_time) VALUES ('" . $strAccountId . "','" . $strConfirmId . "','" . $DATA["transactionId"] . "','" . $strAmout . "','" . $resCode . "','" . $date . "')";

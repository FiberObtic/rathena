			  ...
			  <div class="ui segment">
				...
				<div class="box-sv box-green" style="margin-top:30px">
					<div class="box-sv-body">
						...
						<li class="list-text">แก้ไขรายละเอียดได้ที่ view.php</li>
						<li class="list-text">แก้ไขรายละเอียดได้ที่ view.php</li>
						<li class="list-text">แก้ไขรายละเอียดได้ที่ view.php</li>
						<li class="list-text">แก้ไขรายละเอียดได้ที่ view.php</li>
						</ul>
				...
				<div class="box-sv box-green" style="margin-top:30px">
					<div class="box-sv-body">
						<div class="box-text-haeder"><i class="fas fa-gift fa-lg"></i> Reward <small>ของรางวัลกิจกรรม</small></div>
						<div class="line-box"></div>
						<ul class="list-unstyled">
						<li class="list-text">แก้ไขรายละเอียดได้ที่ view.php</li>
						<li class="list-text">แก้ไขรายละเอียดได้ที่ view.php</li>
